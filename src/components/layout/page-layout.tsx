      ...
      <header className={`${bgColor} text-white`}>
        <div className="flex items-center justify-between px-4 py-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href={ROUTES.GUIA}
              className={`px-2 py-1 text-xs font-medium rounded transition-colors ${pathname === ROUTES.GUIA ? "bg-white text-gray-800" : `text-white/80 hover:text-white ${hoverColor}`}`}
            >
              📖 Guía
            </Link>
          </div>
