...
import { SeccionDerechosAgua, SeccionPermisos, SeccionSeguros } from './tab-legal-secciones'
    ...
    <div>
      ...
      <div className="p-3 bg-yellow-50 border border-yellow-200 rounded mb-3">
        <p className="text-sm text-yellow-800">
          <strong>Inscripcion SAG:</strong> OBLIGATORIA para vender productos agricolas
        </p>
      </div>
      <div className="space-y-2">
        ...
        <div className="mt-2">
          <label className="block text-sm font-medium text-gray-700 mb-1">RUT Agricola</label>
          <input
            type="text"
