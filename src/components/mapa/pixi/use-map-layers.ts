...
interface LayerProps {
  ...
  modo: string
  zonaPreview?: { x: number; y: number; ancho: number; alto: number; esValida: boolean } | null
...
export function useMapLayers(
  ...
  }, [app, terreno.ancho_m, terreno.alto_m, worldRef, gridLayerRef, zonasLayerRef, hitTestRef, overlayLayerRef, propsRef])
  ...
  }, [zonas, zonaSeleccionadaId, viewport, zonaCultivoColor, modo, zonasLayerRef, onZonaClick])
  ...
  }, [plantas, zonas, cultivosEspaciado, cultivosColores, viewport, plantasLayerRef, plantasSeleccionadasIds])
