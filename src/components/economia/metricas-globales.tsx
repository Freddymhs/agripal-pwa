...
export function MetricasGlobales({ avgCostoKg, totalKg, avgMargen, mejorRecuperacion }: MetricasGlobalesProps) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      ...
      <div className="bg-white rounded-lg shadow p-4 text-center">
        ...
        <div className="text-xs text-purple-600 mt-1">Produccion Anual (Ano 3)</div>
      </div>
      <div className="bg-white rounded-lg shadow p-4 text-center">
        <div className={`text-3xl font-bold ${
          avgMargen > MARGEN_BUENO_PCT ? 'text-green-700' : avgMargen > MARGEN_BAJO_PCT ? 'text-yellow-700' : 'text-red-700'
        }`}>
        ...
        <div className={`text-xs mt-1 px-2 py-0.5 rounded-full inline-block ${
          ...
          {avgMargen > MARGEN_BUENO_PCT ? 'Saludable' : avgMargen > MARGEN_BAJO_PCT ? 'Ajustado' : 'Riesgo'}
        </div>
      </div>
      <div className="bg-white rounded-lg shadow p-4 text-center">
