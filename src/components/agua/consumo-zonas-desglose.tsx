...
export function ConsumoZonasDesglose({ zonasConsumo, mostrarDesglose, onToggle }: ConsumoZonasDesgloseProps) {
          ...
          {zonasConsumo.map(({ zona, consumo, porcentaje: pct }) => (
            <div key={zona.id} className="flex items-center justify-between text-sm bg-gray-50 p-2 rounded">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full" style={{ backgroundColor: zona.color }} />
