  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <span className="capitalize font-medium text-gray-900">{planta.estado}</span>
      </div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-medium text-green-900">{ETAPA_INFO[etapaActual].label}</div>
              <div className="text-xs text-green-700">Kc: {kc.toFixed(2)}</div>
            </div>
          </div>
          {diasRestantes !== null && diasRestantes > 0 && (
            <div className="text-right">
              <div className="text-sm font-medium text-green-800">{diasRestantes}d</div>
      ...
      <div className="space-y-2 text-sm">
        ...
        {cultivo && (
          <>
            <div className="text-gray-900">
              <span className="text-gray-700 font-medium">Tiempo producción:</span>{' '}
      ...
      <div>
        <label className="block text-sm font-medium text-gray-900 mb-2">Cambiar estado</label>
