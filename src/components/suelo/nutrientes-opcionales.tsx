...
export function NutrientesOpcionales({ quimico, onChangeQuimico }: NutrientesOpcionalesProps) {
  const fields: Array<{ key: keyof typeof quimico; label: string; max: number }> = [
        ...
        {fields.map(({ key, label, max }) => (
          <div key={key}>
            ...
            <input
              ...
              onChange={(e) => onChangeQuimico({ ...quimico, [key]: safeParseFloat(e.target.value.trim()) })}
