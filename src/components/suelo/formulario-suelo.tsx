        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Óptimo: {umbralPh.min} - {umbralPh.max}
            </p>
          </div>
          ...
          <div className="col-span-2">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Mínimo {umbralProfundidad.min}cm para frutales
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
          <label className="flex items-center gap-2">
            <input
              ...
              onChange={(e) =>
                setQuimico({ ...quimico, analisis_realizado: e.target.checked })
              }
              className="rounded"
            />
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setQuimico({ ...quimico, fecha_analisis: e.target.value })
                }
                className="w-full px-3 py-2 border rounded text-gray-900"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setQuimico({ ...quimico, laboratorio: e.target.value })
                }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setQuimico({
                  ...quimico,
                  nitrogeno_ppm: safeParseFloat(e.target.value.trim()),
                });
              }}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setQuimico({
                  ...quimico,
                  fosforo_ppm: safeParseFloat(e.target.value.trim()),
                });
              }}
              className="w-full px-2 py-1 border rounded text-sm text-gray-900"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setQuimico({
                  ...quimico,
                  potasio_ppm: safeParseFloat(e.target.value.trim()),
                });
              }}
              className="w-full px-2 py-1 border rounded text-sm text-gray-900"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setQuimico({
                  ...quimico,
                  calcio_ppm: safeParseFloat(e.target.value.trim()),
                });
              }}
              className="w-full px-2 py-1 border rounded text-sm text-gray-900"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                setQuimico({
                  ...quimico,
                  magnesio_ppm: safeParseFloat(e.target.value.trim()),
                });
              }}
              className="w-full px-2 py-1 border rounded text-sm text-gray-900"
            />
