      ...
      soluciones: [
        {
          ...
          descripcion: 'Aplicar riego abundante para lavar sales hacia capas profundas. Requiere buen drenaje.',
          costo: 'Bajo (solo agua)',
          efectividad: 'Alta si hay buen drenaje',
        },
        {
          titulo: 'Yeso agrícola',
          descripcion: 'Aplicar yeso (CaSO₄) para desplazar sodio. Dosis: 2-5 ton/ha según análisis.',
          costo: 'Medio (~$200,000-500,000 CLP/ha)',
          efectividad: 'Alta para suelos sódicos',
        },
        {
          titulo: 'Cultivos halófitos',
          descripcion: 'Cambiar a cultivos tolerantes a sal: quinoa, espárrago, remolacha, algunas forrajeras.',
          costo: 'Variable',
          efectividad: 'Alternativa viable',
        },
        {
          titulo: 'Enmiendas orgánicas',
          descripcion: 'Agregar compost o guano para mejorar estructura y retención. Mejora a largo plazo.',
          costo: 'Medio',
      ...
      soluciones: [
        {
          ...
          descripcion: 'Instalar sistema de ósmosis inversa o filtros especializados para agua de riego.',
          costo: 'Alto ($2-5M CLP instalación + mantención)',
          efectividad: 'Alta si el boro viene del agua',
        },
        {
          titulo: 'Fuente de agua alternativa',
          descripcion: 'Buscar agua de mejor calidad: aljibe de zona sin boro, pozo profundo, o agua de Azapa.',
          costo: 'Variable según disponibilidad',
          efectividad: 'Alta',
        },
        {
          titulo: 'Cultivos tolerantes a boro',
          descripcion: 'Pocos cultivos toleran alto boro: tuna, higuera, olivo, vid. Descartar frutales sensibles.',
        ...
        ...(esExtremadamenteAlto ? [{
          ...
          descripcion: 'Con boro >5 mg/L, muy pocos cultivos son viables. Considerar uso no agrícola del terreno.',
          efectividad: 'N/A',
        }] : []),
      ],
    })
      ...
      soluciones: [
        {
          ...
          descripcion: 'El arsénico es tóxico y se acumula en cultivos. NO plantar para consumo humano sin remediación.',
          efectividad: 'CRÍTICO',
        },
        {
          titulo: 'Análisis profesional',
          descripcion: 'Consultar con SAG/SEREMI de Salud para evaluar opciones. Puede requerir biorremediación.',
          costo: 'Variable',
          efectividad: 'Requiere evaluación experta',
        },
        {
          titulo: 'Cultivos no alimentarios',
          descripcion: 'Si se usa el terreno: solo cultivos ornamentales o forestales, NUNCA para consumo.',
          efectividad: 'Alternativa limitada',
        },
        {
          titulo: 'Proyecto no viable',
          descripcion: 'Para agricultura alimentaria, el terreno puede NO ser viable. Evaluar uso alternativo.',
    ...
    <div className="bg-white rounded-lg border shadow-sm">
        ...
        {problemas.map((item, index) => (
          <div key={index} className="p-4">
            <div className={`mb-3 p-2 rounded ${
              item.severidad === 'critica' ? 'bg-red-100 text-red-800' : 'bg-orange-100 text-orange-800'
            }`}>
              <span className="font-medium">{item.severidad === 'critica' ? '🚨' : '⚠️'} {item.problema}</span>
            </div>

            <h4 className="text-sm font-medium text-gray-700 mb-2">Posibles soluciones:</h4>
      ...
      <div className="p-4 bg-blue-50 border-t border-blue-200">
        <p className="text-sm text-blue-800">
          <strong>Importante:</strong> Consulta con un agrónomo o técnico INDAP antes de implementar cualquier solución.
          Las enmiendas incorrectas pueden empeorar el problema.
        </p>
      </div>
    </div>
  )
