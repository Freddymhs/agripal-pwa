      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-base text-gray-600">
            ...
            proyectos (tu negocio o ensayo) y terrenos (la superficie que vas a disenar).
          </p>
        </div>
        <Link
          href="/terrenos"
      ...
      <div className="space-y-2 text-base text-gray-700">
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            ...
            puedes crear/editar/eliminar proyectos y terrenos, y ver un resumen rapido (area, zonas, plantas).
          </li>
          <li>
            Desde la tarjeta de un terreno, usa <strong>&quot;Ver en Mapa&quot;</strong> para trabajar sobre el
...
export function GuiaPasoCatalogo() {
  return (
    <section id="paso-3" className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold text-gray-900">Paso 2: Revisar/editar el Catalogo de Cultivos</h2>
          <p className="text-base text-gray-600">
            El catalogo define los cultivos disponibles y sus parametros tecnicos (demanda de agua, rendimiento, precios, etc.).
            Todo lo demas (agua, economia, recomendaciones) se basa en estos datos.
          </p>
        </div>
        <Link
          href="/catalogo"
      ...
      <div className="grid gap-3 text-base text-gray-700 md:grid-cols-2">
        ...
        <div className="space-y-1">
          <h3 className="font-semibold text-gray-900">3.2 Catalogo predeterminado</h3>
          <ul className="list-disc list-inside space-y-1">
            <li>Todos los proyectos incluyen automaticamente una base de datos de cultivos adaptados para la region de Arica.</li>
            <li>Puedes editar cualquier cultivo para ajustarlo a tu realidad especifica.</li>
            <li>Tambien puedes agregar nuevos cultivos o eliminar los que no uses.</li>
          </ul>
        </div>
      </div>
      ...
      <div className="space-y-1 text-base text-gray-700">
        ...
        <p>
          En la parte inferior veras tarjetas de <strong>Tecnicas de Mejora</strong> (fertilizacion, manejo, etc.),
          con efecto, dosis, frecuencia y costo. No se aplican automaticamente, pero sirven como referencia tecnica
          para tus decisiones.
        </p>
      </div>

      <div className="bg-blue-50 border border-blue-200 rounded p-3 text-base text-blue-800">
        Consejo: primero adapta el catalogo a las especies y variedades que realmente vas a usar.
        Esto hace que el planificador de agua y la economia sean mucho mas realistas.
      </div>
    </section>
  )
}
    ...
    <section id="paso-4" className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm space-y-3">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-base text-gray-600">
            Aqui solo defines reglas de agua: calidad, fuentes, contingencias y ahorro.
            El registro de litros y recargas vendra despues, cuando ya tengas un estanque creado en el mapa.
          </p>
        </div>
        <Link
        ...
        <div className="space-y-1">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              ...
              Sin analisis real, los calculos seran solo aproximados.
            </li>
          </ul>
        </div>
        <div className="space-y-1">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              En <strong>&quot;Proveedores&quot;</strong> define de donde viene tu agua (canal, pozo, camion, etc.)
              y su costo aproximado; se usa luego en los calculos economicos.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid gap-3 text-base text-gray-700 md:grid-cols-2">
        ...
        <div className="space-y-1">
          <h3 className="font-semibold text-gray-900">4.4 Tecnicas de ahorro de agua</h3>
          <ul className="list-disc list-inside space-y-1">
            <li>
              En <strong>&quot;Tecnicas Ahorro&quot;</strong> registra practicas como mulch, riego nocturno, etc.
      ...
      <div className="bg-cyan-50 border border-cyan-200 rounded p-3 text-base text-cyan-800">
        ...
        <ul className="list-disc list-inside mt-1 space-y-1">
          ...
          <li>
            ...
            para simular recargas automaticas, costos y riesgos de deficit.
          </li>
        </ul>
      </div>
    </section>
