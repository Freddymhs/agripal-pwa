    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-gray-50 p-2 rounded text-xs">
          ...
          <div className="font-medium text-gray-900">
            {formatCLP(roi.costo_agua_anual)}
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-2 rounded text-xs space-y-1">
        ...
        <div className="flex justify-between">
          ...
          <span className="text-gray-900">
            {Math.round(roi.kg_año2)} kg → {formatCLP(roi.ingreso_año2)}
          </span>
        </div>
        <div className="flex justify-between">
          <span className="text-gray-500">Año 3</span>
          <span className="text-gray-900">
            {Math.round(roi.kg_año3)} kg → {formatCLP(roi.ingreso_año3)}
          </span>
        </div>
        <div className="flex justify-between">
      ...
      <div
        className={`p-2 rounded text-xs ${roi.viable ? "bg-green-50" : "bg-red-50"}`}
      >
        <div className="flex justify-between">
