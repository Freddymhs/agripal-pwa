      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-blue-700">
            La calidad del agua limita qué cultivos puedes plantar. Agua del Lluta tiene {'>'}11 ppm boro (tóxico para muchos cultivos).
            <br />
        ...
        <div className="bg-white rounded-lg border p-4">
          {activeTab === 'calidad' && (
            <FormularioCalidadAgua calidad={calidad} onChange={handleCalidadChange} />
          )}

          {activeTab === 'proveedores' && (
            <ProveedoresAgua proveedores={proveedores} onChange={setProveedores} />
          )}
