...
import { calcularDensidadPlantas, calcularAguaPromedioHaAño } from '@/lib/utils/helpers-cultivo'
...
export function compararCultivos(
  ...
  return cultivos.map(cultivo => {
    const { numPlantas } = calcularDensidadPlantas(cultivo.espaciado_recomendado_m, zona.area_m2)
