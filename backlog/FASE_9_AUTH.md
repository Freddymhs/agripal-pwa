...
- [ ] Hook useAuth maneja estado de autenticación
- [ ] Login guarda token en localStorage
- [ ] Logout elimina token
- [ ] Token se verifica al cargar la app
- [ ] Página de login funciona
- [ ] En desarrollo, cualquier email/password crea usuario
- [ ] AuthProvider disponible para toda la app
- [ ] Usuario persistido en IndexedDB
