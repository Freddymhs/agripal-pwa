...
- [ ] Catálogo es por proyecto (no global)
- [ ] Lista de cultivos muestra cards con info
- [ ] Se puede agregar nuevo cultivo
- [ ] Se puede editar cultivo existente
- [ ] Se puede eliminar cultivo
- [ ] Formulario valida campos requeridos
- [ ] Tier y riesgo tienen visual diferenciado
